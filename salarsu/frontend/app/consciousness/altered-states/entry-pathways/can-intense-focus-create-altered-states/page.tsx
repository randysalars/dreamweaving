...
const pageUrl = `${getSiteUrl()}/consciousness/altered-states/entry-pathways/can-intense-focus-create-altered-states`;

export const metadata: Metadata = {
  title: "Can intense focus create altered states? | Salars Consciousness",
  description: "Exploring can intense focus create altered states - understanding consciousness and awareness.",
  alternates: { canonical: pageUrl },
  openGraph: {
    title: "Can intense focus create altered states?",
    description: "Exploring can intense focus create altered states - understanding consciousness and awareness.",
    url: pageUrl,
    type: "article",
  },
  keywords: ["altered states", "consciousness", "awareness", "intense", "focus", "create"],
};

export default function CanIntenseFocusCreateAlteredStatesPage() {
  return (
      ...
      <main className="container mx-auto px-4 py-12">
        <div className="mx-auto max-w-3xl space-y-8">
          ...
          <h1 className="text-4xl font-semibold tracking-tight text-foreground">
            Can intense focus create altered states?
          </h1>
          ...
          <section className="rounded-2xl border border-border bg-card/40 p-6">
            ...
            <p className="text-lg text-foreground leading-relaxed">
              [Claude: Write a 20-35 word direct answer to: Can intense focus create altered states?]
            </p>
          </section>
          ...
          <section className="space-y-3">
            ...
            <p className="text-muted-foreground leading-relaxed">
              [Claude: Explain in 2-4 sentences why can intense focus create altered states matters and what mechanisms are involved]
            </p>
          </section>
