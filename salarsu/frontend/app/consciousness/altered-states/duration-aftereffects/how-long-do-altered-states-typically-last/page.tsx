...
const pageUrl = `${getSiteUrl()}/consciousness/altered-states/duration-aftereffects/how-long-do-altered-states-typically-last`;

export const metadata: Metadata = {
  title: "How long do altered states typically last? | Salars Consciousness",
  description: "Exploring how long do altered states typically last - understanding consciousness and awareness.",
  ...
  keywords: ["altered states", "consciousness", "awareness", "altered", "states", "typically"],
};
      ...
      <main className="container mx-auto px-4 py-12">
        <div className="mx-auto max-w-3xl space-y-8">
          ...
          <h1 className="text-4xl font-semibold tracking-tight text-foreground">
            How long do altered states typically last?
          </h1>
          ...
          <section className="rounded-2xl border border-border bg-card/40 p-6">
            ...
            <p className="text-lg text-foreground leading-relaxed">
              [Claude: Write a 20-35 word direct answer to: How long do altered states typically last?]
            </p>
          </section>
          ...
          <section className="space-y-3">
            ...
            <p className="text-muted-foreground leading-relaxed">
              [Claude: Explain in 2-4 sentences why how long do altered states typically last matters and what mechanisms are involved]
            </p>
          </section>
