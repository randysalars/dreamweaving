...
const pageUrl = `${getSiteUrl()}/consciousness/altered-states/safety-and-risks/when-should-altered-states-be-avoided-entirely`;

export const metadata: Metadata = {
  title: "When should altered states be avoided entirely? | Salars Consciousness",
  description: "Exploring when should altered states be avoided entirely - understanding consciousness and awareness.",
  ...
  keywords: ["altered states", "consciousness", "awareness", "should", "altered", "states"],
};
        ...
        <div className="mx-auto max-w-3xl space-y-8">
          ...
          <section className="rounded-2xl border border-border bg-card/40 p-6">
            ...
            <p className="text-lg text-foreground leading-relaxed">
              [Claude: Write a 20-35 word direct answer to: When should altered states be avoided entirely?]
            </p>
          </section>
          ...
          <section className="space-y-3">
            ...
            <p className="text-muted-foreground leading-relaxed">
              [Claude: Explain in 2-4 sentences why when should altered states be avoided entirely matters and what mechanisms are involved]
            </p>
          </section>
