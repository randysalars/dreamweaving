...
const pageUrl = `${getSiteUrl()}/consciousness/altered-states/safety-and-risks/who-should-avoid-certain-altered-states`;

export const metadata: Metadata = {
  title: "Who should avoid certain altered states? | Salars Consciousness",
  description: "Exploring who should avoid certain altered states - understanding consciousness and awareness.",
  ...
  keywords: ["altered states", "consciousness", "awareness", "should", "avoid", "certain"],
};
      ...
      <main className="container mx-auto px-4 py-12">
        <div className="mx-auto max-w-3xl space-y-8">
          ...
          <h1 className="text-4xl font-semibold tracking-tight text-foreground">
            Who should avoid certain altered states?
          </h1>
          ...
          <section className="rounded-2xl border border-border bg-card/40 p-6">
            ...
            <p className="text-lg text-foreground leading-relaxed">
              [Claude: Write a 20-35 word direct answer to: Who should avoid certain altered states?]
            </p>
          </section>
          ...
          <section className="space-y-3">
            ...
            <p className="text-muted-foreground leading-relaxed">
              [Claude: Explain in 2-4 sentences why who should avoid certain altered states matters and what mechanisms are involved]
            </p>
          </section>
