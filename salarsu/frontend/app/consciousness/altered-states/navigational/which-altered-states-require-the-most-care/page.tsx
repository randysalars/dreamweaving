...
const pageUrl = `${getSiteUrl()}/consciousness/altered-states/navigational/which-altered-states-require-the-most-care`;
      ...
      <main className="container mx-auto px-4 py-12">
        <div className="mx-auto max-w-3xl space-y-8">
          ...
          <h1 className="text-4xl font-semibold tracking-tight text-foreground">
            Which altered states require the most care?
          </h1>
