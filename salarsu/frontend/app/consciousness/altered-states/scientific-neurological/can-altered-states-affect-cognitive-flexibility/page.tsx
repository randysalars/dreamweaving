...
const pageUrl = `${getSiteUrl()}/consciousness/altered-states/scientific-neurological/can-altered-states-affect-cognitive-flexibility`;

export const metadata: Metadata = {
  title: "Can altered states affect cognitive flexibility? | Salars Consciousness",
  description: "Exploring can altered states affect cognitive flexibility - understanding consciousness and awareness.",
  ...
  keywords: ["altered states", "consciousness", "awareness", "altered", "states", "affect"],
};
      ...
      <main className="container mx-auto px-4 py-12">
        <div className="mx-auto max-w-3xl space-y-8">
          ...
          <h1 className="text-4xl font-semibold tracking-tight text-foreground">
            Can altered states affect cognitive flexibility?
          </h1>
          ...
          <section className="rounded-2xl border border-border bg-card/40 p-6">
            ...
            <p className="text-lg text-foreground leading-relaxed">
              [Claude: Write a 20-35 word direct answer to: Can altered states affect cognitive flexibility?]
            </p>
          </section>
          ...
          <section className="space-y-3">
            ...
            <p className="text-muted-foreground leading-relaxed">
              [Claude: Explain in 2-4 sentences why can altered states affect cognitive flexibility matters and what mechanisms are involved]
            </p>
          </section>
