...
export const metadata: Metadata = {
  ...
  description: "Exploring can altered states alter sense of self - understanding consciousness and awareness.",
        ...
        <div className="mx-auto max-w-3xl space-y-8">
          ...
          <section className="rounded-2xl border border-border bg-card/40 p-6">
            ...
            <p className="text-lg text-foreground leading-relaxed">
              [Claude: Write a 20-35 word direct answer to: Can altered states alter sense of self?]
            </p>
          </section>
          ...
          <section className="space-y-3">
            ...
            <p className="text-muted-foreground leading-relaxed">
              [Claude: Explain in 2-4 sentences why can altered states alter sense of self matters and what mechanisms are involved]
            </p>
          </section>
