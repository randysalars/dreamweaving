...
const pageUrl = `${getSiteUrl()}/consciousness/altered-states/subjective-experience/do-altered-states-change-body-awareness`;

export const metadata: Metadata = {
  title: "Do altered states change body awareness? | Salars Consciousness",
  description: "Exploring do altered states change body awareness - understanding consciousness and awareness.",
  ...
  keywords: ["altered states", "consciousness", "awareness", "altered", "states", "change"],
};
      ...
      <main className="container mx-auto px-4 py-12">
        <div className="mx-auto max-w-3xl space-y-8">
          ...
          <h1 className="text-4xl font-semibold tracking-tight text-foreground">
            Do altered states change body awareness?
          </h1>
          ...
          <section className="rounded-2xl border border-border bg-card/40 p-6">
            ...
            <p className="text-lg text-foreground leading-relaxed">
              [Claude: Write a 20-35 word direct answer to: Do altered states change body awareness?]
            </p>
          </section>
          ...
          <section className="space-y-3">
            ...
            <p className="text-muted-foreground leading-relaxed">
              [Claude: Explain in 2-4 sentences why do altered states change body awareness matters and what mechanisms are involved]
            </p>
          </section>
