...
const pageUrl = `${getSiteUrl()}/consciousness/altered-states/subjective-experience/can-altered-states-feel-frightening`;

export const metadata: Metadata = {
  title: "Can altered states feel frightening? | Salars Consciousness",
  description: "Exploring can altered states feel frightening - understanding consciousness and awareness.",
  ...
  keywords: ["altered states", "consciousness", "awareness", "altered", "states", "frightening"],
};
        ...
        <div className="mx-auto max-w-3xl space-y-8">
          ...
          <section className="rounded-2xl border border-border bg-card/40 p-6">
            ...
            <p className="text-lg text-foreground leading-relaxed">
              [Claude: Write a 20-35 word direct answer to: Can altered states feel frightening?]
            </p>
          </section>
          ...
          <section className="space-y-3">
            ...
            <p className="text-muted-foreground leading-relaxed">
              [Claude: Explain in 2-4 sentences why can altered states feel frightening matters and what mechanisms are involved]
            </p>
          </section>
