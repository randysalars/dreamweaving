...
const pageUrl = `${getSiteUrl()}/consciousness/altered-states/cultural-historical/are-altered-states-universal-across-cultures`;

export const metadata: Metadata = {
  title: "Are altered states universal across cultures? | Salars Consciousness",
  description: "Exploring are altered states universal across cultures - understanding consciousness and awareness.",
  ...
  keywords: ["altered states", "consciousness", "awareness", "altered", "states", "universal"],
};
      ...
      <main className="container mx-auto px-4 py-12">
        <div className="mx-auto max-w-3xl space-y-8">
          ...
          <h1 className="text-4xl font-semibold tracking-tight text-foreground">
            Are altered states universal across cultures?
          </h1>
          ...
          <section className="rounded-2xl border border-border bg-card/40 p-6">
            ...
            <p className="text-lg text-foreground leading-relaxed">
              [Claude: Write a 20-35 word direct answer to: Are altered states universal across cultures?]
            </p>
          </section>
          ...
          <section className="space-y-3">
            ...
            <p className="text-muted-foreground leading-relaxed">
              [Claude: Explain in 2-4 sentences why are altered states universal across cultures matters and what mechanisms are involved]
            </p>
          </section>
