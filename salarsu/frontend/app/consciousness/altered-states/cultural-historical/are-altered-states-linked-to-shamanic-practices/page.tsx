...
const pageUrl = `${getSiteUrl()}/consciousness/altered-states/cultural-historical/are-altered-states-linked-to-shamanic-practices`;

export const metadata: Metadata = {
  title: "Are altered states linked to shamanic practices? | Salars Consciousness",
  description: "Exploring are altered states linked to shamanic practices - understanding consciousness and awareness.",
      ...
      <main className="container mx-auto px-4 py-12">
        <div className="mx-auto max-w-3xl space-y-8">
          ...
          <h1 className="text-4xl font-semibold tracking-tight text-foreground">
            Are altered states linked to shamanic practices?
          </h1>
          ...
          <section className="rounded-2xl border border-border bg-card/40 p-6">
            ...
            <p className="text-lg text-foreground leading-relaxed">
              [Claude: Write a 20-35 word direct answer to: Are altered states linked to shamanic practices?]
            </p>
          </section>
          ...
          <section className="space-y-3">
            ...
            <p className="text-muted-foreground leading-relaxed">
              [Claude: Explain in 2-4 sentences why are altered states linked to shamanic practices matters and what mechanisms are involved]
            </p>
          </section>
