...
export const metadata: Metadata = {
  ...
  description: "Exploring are extreme altered states rare - understanding consciousness and awareness.",
  ...
  keywords: ["altered states", "consciousness", "awareness", "extreme", "altered", "states"],
};
        ...
        <div className="mx-auto max-w-3xl space-y-8">
          ...
          <section className="rounded-2xl border border-border bg-card/40 p-6">
            ...
            <p className="text-lg text-foreground leading-relaxed">
              [Claude: Write a 20-35 word direct answer to: Are extreme altered states rare?]
            </p>
          </section>
          ...
          <section className="space-y-3">
            ...
            <p className="text-muted-foreground leading-relaxed">
              [Claude: Explain in 2-4 sentences why are extreme altered states rare matters and what mechanisms are involved]
            </p>
          </section>
