...
const pageUrl = `${getSiteUrl()}/consciousness/altered-states/levels-and-depth/can-a-person-control-the-depth-of-an-altered-state`;

export const metadata: Metadata = {
  title: "Can a person control the depth of an altered state? | Salars Consciousness",
  description: "Exploring can a person control the depth of an altered state - understanding consciousness and awareness.",
  ...
  keywords: ["altered states", "consciousness", "awareness", "person", "control", "depth"],
};
      ...
      <main className="container mx-auto px-4 py-12">
        <div className="mx-auto max-w-3xl space-y-8">
          ...
          <h1 className="text-4xl font-semibold tracking-tight text-foreground">
            Can a person control the depth of an altered state?
          </h1>
          ...
          <section className="rounded-2xl border border-border bg-card/40 p-6">
            ...
            <p className="text-lg text-foreground leading-relaxed">
              [Claude: Write a 20-35 word direct answer to: Can a person control the depth of an altered state?]
            </p>
          </section>
          ...
          <section className="space-y-3">
            ...
            <p className="text-muted-foreground leading-relaxed">
              [Claude: Explain in 2-4 sentences why can a person control the depth of an altered state matters and what mechanisms are involved]
            </p>
          </section>
