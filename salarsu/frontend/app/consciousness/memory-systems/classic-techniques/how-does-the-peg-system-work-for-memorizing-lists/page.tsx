...
const pageUrl = `${getSiteUrl()}/consciousness/memory/classic-techniques/how-does-the-peg-system-work-for-memorizing-lists`;

export const metadata: Metadata = {
  title: "How does the peg system work for memorizing lists? | Salars Consciousness",
  description: "How does the peg system work for memorizing lists?",
  alternates: { canonical: pageUrl },
  openGraph: {
    title: "How does the peg system work for memorizing lists?",
    description: "How does the peg system work for memorizing lists?",
    url: pageUrl,
    type: "article",
  },
...
export default function HowDoesThePegSystemWorkForMemorizingListsPage() {
  return (
        ...
        <div className="mx-auto max-w-3xl space-y-8">
          ...
          <section className="rounded-2xl border border-border bg-card/40 p-6">
            ...
            <p className="text-lg text-foreground leading-relaxed">
              [Claude: Write 20-35 word answer to "How does the peg system work for memorizing lists?"]
            </p>
          </section>
