...
const pageUrl = `${getSiteUrl()}/consciousness/memory/modern-approaches/what-is-spaced-repetition-and-why-does-it-work`;

export const metadata: Metadata = {
  title: "What is spaced repetition and why does it work? | Salars Consciousness",
  description: "What is spaced repetition and why does it work?",
...
export default function WhatIsSpacedRepetitionAndWhyDoesItWorkPage() {
  return (
        ...
        <div className="mx-auto max-w-3xl space-y-8">
          ...
          <section className="rounded-2xl border border-border bg-card/40 p-6">
            ...
            <p className="text-lg text-foreground leading-relaxed">
              [Claude: Write 20-35 word answer to "What is spaced repetition and why does it work?"]
            </p>
          </section>
