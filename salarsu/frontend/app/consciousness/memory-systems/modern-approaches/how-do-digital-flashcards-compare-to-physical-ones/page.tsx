...
const pageUrl = `${getSiteUrl()}/consciousness/memory/modern-approaches/how-do-digital-flashcards-compare-to-physical-ones`;

export const metadata: Metadata = {
  title: "How do digital flashcards compare to physical ones? | Salars Consciousness",
  description: "How do digital flashcards compare to physical ones?",
  alternates: { canonical: pageUrl },
  openGraph: {
    title: "How do digital flashcards compare to physical ones?",
    description: "How do digital flashcards compare to physical ones?",
    url: pageUrl,
    type: "article",
  },
...
export default function HowDoDigitalFlashcardsCompareToPhysicalOnesPage() {
  return (
        ...
        <div className="mx-auto max-w-3xl space-y-8">
          ...
          <section className="rounded-2xl border border-border bg-card/40 p-6">
            ...
            <p className="text-lg text-foreground leading-relaxed">
              [Claude: Write 20-35 word answer to "How do digital flashcards compare to physical ones?"]
            </p>
          </section>
