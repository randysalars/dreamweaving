...
const pageUrl = `${getSiteUrl()}/consciousness/memory/modern-approaches/how-does-interleaving-improve-long-term-retention`;

export const metadata: Metadata = {
  title: "How does interleaving improve long-term retention? | Salars Consciousness",
  description: "How does interleaving improve long-term retention?",
  alternates: { canonical: pageUrl },
  openGraph: {
    title: "How does interleaving improve long-term retention?",
    description: "How does interleaving improve long-term retention?",
    url: pageUrl,
    type: "article",
  },
...
export default function HowDoesInterleavingImproveLongTermRetentionPage() {
  return (
      ...
      <main className="container mx-auto px-4 py-12">
        <div className="mx-auto max-w-3xl space-y-8">
          ...
          <h1 className="text-4xl font-semibold tracking-tight text-foreground">
            How does interleaving improve long-term retention?
          </h1>
          ...
          <section className="rounded-2xl border border-border bg-card/40 p-6">
            ...
            <p className="text-lg text-foreground leading-relaxed">
              [Claude: Write 20-35 word answer to "How does interleaving improve long-term retention?"]
            </p>
          </section>
