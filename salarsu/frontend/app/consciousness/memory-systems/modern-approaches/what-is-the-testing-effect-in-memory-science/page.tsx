...
const pageUrl = `${getSiteUrl()}/consciousness/memory/modern-approaches/what-is-the-testing-effect-in-memory-science`;

export const metadata: Metadata = {
  title: "What is the testing effect in memory science? | Salars Consciousness",
  description: "What is the testing effect in memory science?",
  alternates: { canonical: pageUrl },
  openGraph: {
    title: "What is the testing effect in memory science?",
    description: "What is the testing effect in memory science?",
    url: pageUrl,
    type: "article",
  },
...
export default function WhatIsTheTestingEffectInMemorySciencePage() {
  return (
      ...
      <main className="container mx-auto px-4 py-12">
        <div className="mx-auto max-w-3xl space-y-8">
          ...
          <h1 className="text-4xl font-semibold tracking-tight text-foreground">
            What is the testing effect in memory science?
          </h1>
          ...
          <section className="rounded-2xl border border-border bg-card/40 p-6">
            ...
            <p className="text-lg text-foreground leading-relaxed">
              [Claude: Write 20-35 word answer to "What is the testing effect in memory science?"]
            </p>
          </section>
