...
const pageUrl = `${getSiteUrl()}/consciousness/memory/modern-approaches/what-is-the-feynman-technique-for-learning-and-memory`;

export const metadata: Metadata = {
  title: "What is the Feynman Technique for learning and memory? | Salars Consciousness",
  description: "What is the Feynman Technique for learning and memory?",
  alternates: { canonical: pageUrl },
  openGraph: {
    title: "What is the Feynman Technique for learning and memory?",
    description: "What is the Feynman Technique for learning and memory?",
    url: pageUrl,
    type: "article",
  },
...
export default function WhatIsTheFeynmanTechniqueForLearningAndMemoryPage() {
  return (
        ...
        <div className="mx-auto max-w-3xl space-y-8">
          ...
          <section className="rounded-2xl border border-border bg-card/40 p-6">
            ...
            <p className="text-lg text-foreground leading-relaxed">
              [Claude: Write 20-35 word answer to "What is the Feynman Technique for learning and memory?"]
            </p>
          </section>
