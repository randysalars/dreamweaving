...
const pageUrl = `${getSiteUrl()}/consciousness/memory/modern-approaches/what-is-elaborative-interrogation-for-memory`;

export const metadata: Metadata = {
  title: "What is elaborative interrogation for memory? | Salars Consciousness",
  description: "What is elaborative interrogation for memory?",
  alternates: { canonical: pageUrl },
  openGraph: {
    title: "What is elaborative interrogation for memory?",
    description: "What is elaborative interrogation for memory?",
    url: pageUrl,
    type: "article",
  },
...
export default function WhatIsElaborativeInterrogationForMemoryPage() {
  return (
      ...
      <main className="container mx-auto px-4 py-12">
        <div className="mx-auto max-w-3xl space-y-8">
          ...
          <h1 className="text-4xl font-semibold tracking-tight text-foreground">
            What is elaborative interrogation for memory?
          </h1>
          ...
          <section className="rounded-2xl border border-border bg-card/40 p-6">
            ...
            <p className="text-lg text-foreground leading-relaxed">
              [Claude: Write 20-35 word answer to "What is elaborative interrogation for memory?"]
            </p>
          </section>
