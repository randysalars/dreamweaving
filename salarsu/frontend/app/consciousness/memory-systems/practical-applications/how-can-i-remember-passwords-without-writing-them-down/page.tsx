...
const pageUrl = `${getSiteUrl()}/consciousness/memory/practical-applications/how-can-i-remember-passwords-without-writing-them-down`;

export const metadata: Metadata = {
  title: "How can I remember passwords without writing them down? | Salars Consciousness",
  description: "How can I remember passwords without writing them down?",
  alternates: { canonical: pageUrl },
  openGraph: {
    title: "How can I remember passwords without writing them down?",
    description: "How can I remember passwords without writing them down?",
    url: pageUrl,
    type: "article",
  },
...
export default function HowCanIRememberPasswordsWithoutWritingThemDownPage() {
  return (
        ...
        <div className="mx-auto max-w-3xl space-y-8">
          ...
          <section className="rounded-2xl border border-border bg-card/40 p-6">
            ...
            <p className="text-lg text-foreground leading-relaxed">
              [Claude: Write 20-35 word answer to "How can I remember passwords without writing them down?"]
            </p>
          </section>
