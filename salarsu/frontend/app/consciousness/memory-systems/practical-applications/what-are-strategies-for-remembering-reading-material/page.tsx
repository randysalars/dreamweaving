...
const pageUrl = `${getSiteUrl()}/consciousness/memory/practical-applications/what-are-strategies-for-remembering-reading-material`;

export const metadata: Metadata = {
  title: "What are strategies for remembering reading material? | Salars Consciousness",
  description: "What are strategies for remembering reading material?",
  alternates: { canonical: pageUrl },
  openGraph: {
    title: "What are strategies for remembering reading material?",
    description: "What are strategies for remembering reading material?",
    url: pageUrl,
    type: "article",
  },
...
export default function WhatAreStrategiesForRememberingReadingMaterialPage() {
  return (
      ...
      <main className="container mx-auto px-4 py-12">
        <div className="mx-auto max-w-3xl space-y-8">
          ...
          <h1 className="text-4xl font-semibold tracking-tight text-foreground">
            What are strategies for remembering reading material?
          </h1>
          ...
          <section className="rounded-2xl border border-border bg-card/40 p-6">
            ...
            <p className="text-lg text-foreground leading-relaxed">
              [Claude: Write 20-35 word answer to "What are strategies for remembering reading material?"]
            </p>
          </section>
