...
const pageUrl = `${getSiteUrl()}/consciousness/memory/practical-applications/what-is-the-best-way-to-remember-names-and-faces`;

export const metadata: Metadata = {
  title: "What is the best way to remember names and faces? | Salars Consciousness",
  description: "What is the best way to remember names and faces?",
  alternates: { canonical: pageUrl },
  openGraph: {
    title: "What is the best way to remember names and faces?",
    description: "What is the best way to remember names and faces?",
    url: pageUrl,
    type: "article",
  },
...
export default function WhatIsTheBestWayToRememberNamesAndFacesPage() {
  return (
        ...
        <div className="mx-auto max-w-3xl space-y-8">
          ...
          <section className="rounded-2xl border border-border bg-card/40 p-6">
            ...
            <p className="text-lg text-foreground leading-relaxed">
              [Claude: Write 20-35 word answer to "What is the best way to remember names and faces?"]
            </p>
          </section>
