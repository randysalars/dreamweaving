...
const pageUrl = `${getSiteUrl()}/consciousness/memory/practical-applications/what-are-effective-strategies-for-memorizing-speeches`;

export const metadata: Metadata = {
  title: "What are effective strategies for memorizing speeches? | Salars Consciousness",
  description: "What are effective strategies for memorizing speeches?",
  alternates: { canonical: pageUrl },
  openGraph: {
    title: "What are effective strategies for memorizing speeches?",
    description: "What are effective strategies for memorizing speeches?",
    url: pageUrl,
    type: "article",
  },
...
export default function WhatAreEffectiveStrategiesForMemorizingSpeechesPage() {
  return (
        ...
        <div className="mx-auto max-w-3xl space-y-8">
          ...
          <section className="rounded-2xl border border-border bg-card/40 p-6">
            ...
            <p className="text-lg text-foreground leading-relaxed">
              [Claude: Write 20-35 word answer to "What are effective strategies for memorizing speeches?"]
            </p>
          </section>
