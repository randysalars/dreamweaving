...
const pageUrl = `${getSiteUrl()}/consciousness/memory/fundamentals/what-causes-forgetting-and-how-can-it-be-prevented`;

export const metadata: Metadata = {
  title: "What causes forgetting and how can it be prevented? | Salars Consciousness",
  description: "What causes forgetting and how can it be prevented?",
  alternates: { canonical: pageUrl },
  openGraph: {
    title: "What causes forgetting and how can it be prevented?",
    description: "What causes forgetting and how can it be prevented?",
    url: pageUrl,
    type: "article",
  },
...
export default function WhatCausesForgettingAndHowCanItBePreventedPage() {
  return (
        ...
        <div className="mx-auto max-w-3xl space-y-8">
          ...
          <section className="rounded-2xl border border-border bg-card/40 p-6">
            ...
            <p className="text-lg text-foreground leading-relaxed">
              [Claude: Write 20-35 word answer to "What causes forgetting and how can it be prevented?"]
            </p>
          </section>
