...
const pageUrl = `${getSiteUrl()}/consciousness/memory/fundamentals/how-does-attention-affect-memory-formation`;

export const metadata: Metadata = {
  title: "How does attention affect memory formation? | Salars Consciousness",
  description: "How does attention affect memory formation?",
  alternates: { canonical: pageUrl },
  openGraph: {
    title: "How does attention affect memory formation?",
    description: "How does attention affect memory formation?",
    url: pageUrl,
    type: "article",
  },
...
export default function HowDoesAttentionAffectMemoryFormationPage() {
  return (
        ...
        <div className="mx-auto max-w-3xl space-y-8">
          ...
          <section className="rounded-2xl border border-border bg-card/40 p-6">
            ...
            <p className="text-lg text-foreground leading-relaxed">
              [Claude: Write 20-35 word answer to "How does attention affect memory formation?"]
            </p>
          </section>
