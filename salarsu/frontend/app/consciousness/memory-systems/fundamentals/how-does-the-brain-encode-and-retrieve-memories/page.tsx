...
const pageUrl = `${getSiteUrl()}/consciousness/memory/fundamentals/how-does-the-brain-encode-and-retrieve-memories`;

export const metadata: Metadata = {
  title: "How does the brain encode and retrieve memories? | Salars Consciousness",
  description: "How does the brain encode and retrieve memories?",
  alternates: { canonical: pageUrl },
  openGraph: {
    title: "How does the brain encode and retrieve memories?",
    description: "How does the brain encode and retrieve memories?",
    url: pageUrl,
    type: "article",
  },
...
export default function HowDoesTheBrainEncodeAndRetrieveMemoriesPage() {
  return (
        ...
        <div className="mx-auto max-w-3xl space-y-8">
          ...
          <section className="rounded-2xl border border-border bg-card/40 p-6">
            ...
            <p className="text-lg text-foreground leading-relaxed">
              [Claude: Write 20-35 word answer to "How does the brain encode and retrieve memories?"]
            </p>
          </section>
