...
const pageUrl = `${getSiteUrl()}/consciousness/sleep-dreams/sleep-fundamentals/can-you-make-up-for-lost-sleep`;

export const metadata: Metadata = {
  title: "Can you make up for lost sleep? | Salars Consciousness",
  description: "Can you make up for lost sleep?",
  alternates: { canonical: pageUrl },
  openGraph: {
    title: "Can you make up for lost sleep?",
    description: "Can you make up for lost sleep?",
    url: pageUrl,
    type: "article",
  },
...
export default function CanYouMakeUpForLostSleepPage() {
  return (
