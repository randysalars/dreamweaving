...
const pageUrl = `${getSiteUrl()}/consciousness/sleep-dreams/sleep-fundamentals/why-do-we-need-sleep`;

export const metadata: Metadata = {
  title: "Why do we need sleep? | Salars Consciousness",
  description: "Why do we need sleep?",
...
export default function WhyDoWeNeedSleepPage() {
  return (
