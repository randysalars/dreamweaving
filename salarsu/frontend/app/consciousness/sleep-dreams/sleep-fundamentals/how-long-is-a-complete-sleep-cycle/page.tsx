...
const pageUrl = `${getSiteUrl()}/consciousness/sleep-dreams/sleep-fundamentals/how-long-is-a-complete-sleep-cycle`;

export const metadata: Metadata = {
  title: "How long is a complete sleep cycle? | Salars Consciousness",
  description: "How long is a complete sleep cycle?",
  alternates: { canonical: pageUrl },
  openGraph: {
    title: "How long is a complete sleep cycle?",
    description: "How long is a complete sleep cycle?",
    url: pageUrl,
    type: "article",
  },
...
export default function HowLongIsACompleteSleepCyclePage() {
  return (
        ...
        <div className="mx-auto max-w-3xl space-y-8">
          ...
          <section className="rounded-2xl border border-border bg-card/40 p-6">
            ...
            <p className="text-lg text-foreground leading-relaxed">
              [Claude: Write 20-35 word answer to "How long is a complete sleep cycle?"]
            </p>
          </section>
