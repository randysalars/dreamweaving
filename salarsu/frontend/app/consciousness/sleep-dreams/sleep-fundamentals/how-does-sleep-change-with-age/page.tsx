...
const pageUrl = `${getSiteUrl()}/consciousness/sleep-dreams/sleep-fundamentals/how-does-sleep-change-with-age`;

export const metadata: Metadata = {
  title: "How does sleep change with age? | Salars Consciousness",
  description: "How does sleep change with age?",
  alternates: { canonical: pageUrl },
  openGraph: {
    title: "How does sleep change with age?",
    description: "How does sleep change with age?",
    url: pageUrl,
    type: "article",
  },
...
export default function HowDoesSleepChangeWithAgePage() {
  return (
        ...
        <div className="mx-auto max-w-3xl space-y-8">
          ...
          <section className="rounded-2xl border border-border bg-card/40 p-6">
            ...
            <p className="text-lg text-foreground leading-relaxed">
              [Claude: Write 20-35 word answer to "How does sleep change with age?"]
            </p>
          </section>
