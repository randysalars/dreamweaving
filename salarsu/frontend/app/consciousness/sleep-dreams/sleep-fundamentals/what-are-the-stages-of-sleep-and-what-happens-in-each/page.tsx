...
const pageUrl = `${getSiteUrl()}/consciousness/sleep-dreams/sleep-fundamentals/what-are-the-stages-of-sleep-and-what-happens-in-each`;

export const metadata: Metadata = {
  title: "What are the stages of sleep and what happens in each? | Salars Consciousness",
  description: "What are the stages of sleep and what happens in each?",
  alternates: { canonical: pageUrl },
  openGraph: {
    title: "What are the stages of sleep and what happens in each?",
    description: "What are the stages of sleep and what happens in each?",
    url: pageUrl,
    type: "article",
  },
...
export default function WhatAreTheStagesOfSleepAndWhatHappensInEachPage() {
  return (
