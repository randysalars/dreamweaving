...
const pageUrl = `${getSiteUrl()}/consciousness/sleep-dreams/sleep-fundamentals/what-is-the-role-of-melatonin-in-sleep`;

export const metadata: Metadata = {
  title: "What is the role of melatonin in sleep? | Salars Consciousness",
  description: "What is the role of melatonin in sleep?",
  alternates: { canonical: pageUrl },
  openGraph: {
    title: "What is the role of melatonin in sleep?",
    description: "What is the role of melatonin in sleep?",
    url: pageUrl,
    type: "article",
  },
...
export default function WhatIsTheRoleOfMelatoninInSleepPage() {
  return (
