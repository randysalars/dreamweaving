...
const pageUrl = `${getSiteUrl()}/consciousness/sleep-dreams/dream-work/how-do-i-interpret-my-dreams`;

export const metadata: Metadata = {
  title: "How do I interpret my dreams? | Salars Consciousness",
  description: "How do I interpret my dreams?",
  alternates: { canonical: pageUrl },
  openGraph: {
    title: "How do I interpret my dreams?",
    description: "How do I interpret my dreams?",
    url: pageUrl,
    type: "article",
  },
...
export default function HowDoIInterpretMyDreamsPage() {
  return (
