...
const pageUrl = `${getSiteUrl()}/consciousness/sleep-dreams/dream-work/what-is-active-imagination-in-dream-work`;

export const metadata: Metadata = {
  title: "What is active imagination in dream work? | Salars Consciousness",
  description: "What is active imagination in dream work?",
  alternates: { canonical: pageUrl },
  openGraph: {
    title: "What is active imagination in dream work?",
    description: "What is active imagination in dream work?",
    url: pageUrl,
    type: "article",
  },
...
export default function WhatIsActiveImaginationInDreamWorkPage() {
  return (
      ...
      <main className="container mx-auto px-4 py-12">
        <div className="mx-auto max-w-3xl space-y-8">
          ...
          <h1 className="text-4xl font-semibold tracking-tight text-foreground">
            What is active imagination in dream work?
          </h1>
