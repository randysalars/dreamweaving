...
const pageUrl = `${getSiteUrl()}/consciousness/sleep-dreams/dream-work/can-dreams-provide-creative-insights`;

export const metadata: Metadata = {
  title: "Can dreams provide creative insights? | Salars Consciousness",
  description: "Can dreams provide creative insights?",
  alternates: { canonical: pageUrl },
  openGraph: {
    title: "Can dreams provide creative insights?",
    description: "Can dreams provide creative insights?",
    url: pageUrl,
    type: "article",
  },
...
export default function CanDreamsProvideCreativeInsightsPage() {
  return (
      ...
      <main className="container mx-auto px-4 py-12">
        <div className="mx-auto max-w-3xl space-y-8">
          ...
          <h1 className="text-4xl font-semibold tracking-tight text-foreground">
            Can dreams provide creative insights?
          </h1>
