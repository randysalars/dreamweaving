...
const pageUrl = `${getSiteUrl()}/consciousness/sleep-dreams/dream-work/what-is-dream-incubation`;

export const metadata: Metadata = {
  title: "What is dream incubation? | Salars Consciousness",
  description: "What is dream incubation?",
...
export default function WhatIsDreamIncubationPage() {
  return (
