...
const pageUrl = `${getSiteUrl()}/consciousness/sleep-dreams/dream-work/how-can-dreams-support-personal-growth`;

export const metadata: Metadata = {
  title: "How can dreams support personal growth? | Salars Consciousness",
  description: "How can dreams support personal growth?",
  alternates: { canonical: pageUrl },
  openGraph: {
    title: "How can dreams support personal growth?",
    description: "How can dreams support personal growth?",
    url: pageUrl,
    type: "article",
  },
...
export default function HowCanDreamsSupportPersonalGrowthPage() {
  return (
      ...
      <main className="container mx-auto px-4 py-12">
        <div className="mx-auto max-w-3xl space-y-8">
          ...
          <h1 className="text-4xl font-semibold tracking-tight text-foreground">
            How can dreams support personal growth?
          </h1>
