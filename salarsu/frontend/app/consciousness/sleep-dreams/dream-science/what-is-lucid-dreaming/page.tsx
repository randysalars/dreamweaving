...
const pageUrl = `${getSiteUrl()}/consciousness/sleep-dreams/dream-science/what-is-lucid-dreaming`;

export const metadata: Metadata = {
  title: "What is lucid dreaming? | Salars Consciousness",
...
export default function WhatIsLucidDreamingPage() {
  return (
