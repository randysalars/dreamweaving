...
const pageUrl = `${getSiteUrl()}/consciousness/sleep-dreams/dream-science/what-is-the-mild-mnemonic-induction-of-lucid-dreams-technique`;

export const metadata: Metadata = {
  title: "What is the MILD (Mnemonic Induction of Lucid Dreams) technique? | Salars Consciousness",
  description: "What is the MILD (Mnemonic Induction of Lucid Dreams) technique?",
  alternates: { canonical: pageUrl },
  openGraph: {
    title: "What is the MILD (Mnemonic Induction of Lucid Dreams) technique?",
    description: "What is the MILD (Mnemonic Induction of Lucid Dreams) technique?",
    url: pageUrl,
    type: "article",
  },
...
export default function WhatIsTheMildMnemonicInductionOfLucidDreamsTechniquePage() {
  return (
