...
const pageUrl = `${getSiteUrl()}/consciousness/sleep-dreams/dream-science/what-are-dreams-and-why-do-we-dream`;

export const metadata: Metadata = {
  title: "What are dreams and why do we dream? | Salars Consciousness",
  description: "What are dreams and why do we dream?",
  alternates: { canonical: pageUrl },
  openGraph: {
    title: "What are dreams and why do we dream?",
    description: "What are dreams and why do we dream?",
    url: pageUrl,
    type: "article",
  },
...
export default function WhatAreDreamsAndWhyDoWeDreamPage() {
  return (
        ...
        <div className="mx-auto max-w-3xl space-y-8">
          ...
          <section className="rounded-2xl border border-border bg-card/40 p-6">
            ...
            <p className="text-lg text-foreground leading-relaxed">
              [Claude: Write 20-35 word answer to "What are dreams and why do we dream?"]
            </p>
          </section>
          ...
          <section className="space-y-4">
            ...
            <div className="grid gap-3">
              ...
              <Link
                href="/consciousness/sleep-dreams/dream-science/what-is-dream-recall-and-how-can-i-improve-it"
                className="flex items-start gap-3 rounded-lg border border-border bg-card/30 p-4 transition-colors hover:bg-card/50"
              >
                <HelpCircle className="h-5 w-5 text-primary mt-0.5 flex-shrink-0" />
                <span className="text-foreground">What is dream recall and how can I improve it?</span>
              </Link>
