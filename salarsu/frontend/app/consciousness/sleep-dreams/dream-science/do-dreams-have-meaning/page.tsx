...
const pageUrl = `${getSiteUrl()}/consciousness/sleep-dreams/dream-science/do-dreams-have-meaning`;

export const metadata: Metadata = {
  title: "Do dreams have meaning? | Salars Consciousness",
  description: "Do dreams have meaning?",
  alternates: { canonical: pageUrl },
  openGraph: {
    title: "Do dreams have meaning?",
    description: "Do dreams have meaning?",
    url: pageUrl,
    type: "article",
  },
...
export default function DoDreamsHaveMeaningPage() {
  return (
