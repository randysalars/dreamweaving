...
const pageUrl = `${getSiteUrl()}/consciousness/sleep-dreams/dream-science/what-is-the-wild-wake-induced-lucid-dream-technique`;

export const metadata: Metadata = {
  title: "What is the WILD (Wake-Induced Lucid Dream) technique? | Salars Consciousness",
  description: "What is the WILD (Wake-Induced Lucid Dream) technique?",
  alternates: { canonical: pageUrl },
  openGraph: {
    title: "What is the WILD (Wake-Induced Lucid Dream) technique?",
    description: "What is the WILD (Wake-Induced Lucid Dream) technique?",
    url: pageUrl,
    type: "article",
  },
...
export default function WhatIsTheWildWakeInducedLucidDreamTechniquePage() {
  return (
