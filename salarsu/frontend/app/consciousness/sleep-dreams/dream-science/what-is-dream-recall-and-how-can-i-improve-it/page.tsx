...
const pageUrl = `${getSiteUrl()}/consciousness/sleep-dreams/dream-science/what-is-dream-recall-and-how-can-i-improve-it`;

export const metadata: Metadata = {
  title: "What is dream recall and how can I improve it? | Salars Consciousness",
  description: "What is dream recall and how can I improve it?",
  alternates: { canonical: pageUrl },
  openGraph: {
    title: "What is dream recall and how can I improve it?",
    description: "What is dream recall and how can I improve it?",
    url: pageUrl,
    type: "article",
  },
...
export default function WhatIsDreamRecallAndHowCanIImproveItPage() {
  return (
      ...
      <main className="container mx-auto px-4 py-12">
        <div className="mx-auto max-w-3xl space-y-8">
          ...
          <h1 className="text-4xl font-semibold tracking-tight text-foreground">
            What is dream recall and how can I improve it?
          </h1>
