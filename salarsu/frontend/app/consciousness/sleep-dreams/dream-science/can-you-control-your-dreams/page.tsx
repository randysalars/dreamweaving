...
const pageUrl = `${getSiteUrl()}/consciousness/sleep-dreams/dream-science/can-you-control-your-dreams`;

export const metadata: Metadata = {
  title: "Can you control your dreams? | Salars Consciousness",
  description: "Can you control your dreams?",
  alternates: { canonical: pageUrl },
  openGraph: {
    title: "Can you control your dreams?",
    description: "Can you control your dreams?",
    url: pageUrl,
    type: "article",
  },
...
export default function CanYouControlYourDreamsPage() {
  return (
