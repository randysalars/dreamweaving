...
const pageUrl = `${getSiteUrl()}/consciousness/sleep-dreams/sleep-performance/how-does-sleep-affect-creativity`;

export const metadata: Metadata = {
  title: "How does sleep affect creativity? | Salars Consciousness",
  description: "How does sleep affect creativity?",
  alternates: { canonical: pageUrl },
  openGraph: {
    title: "How does sleep affect creativity?",
    description: "How does sleep affect creativity?",
    url: pageUrl,
    type: "article",
  },
...
export default function HowDoesSleepAffectCreativityPage() {
  return (
