...
const pageUrl = `${getSiteUrl()}/consciousness/sleep-dreams/sleep-performance/what-are-the-effects-of-sleep-deprivation`;

export const metadata: Metadata = {
  title: "What are the effects of sleep deprivation? | Salars Consciousness",
  description: "What are the effects of sleep deprivation?",
  alternates: { canonical: pageUrl },
  openGraph: {
    title: "What are the effects of sleep deprivation?",
    description: "What are the effects of sleep deprivation?",
    url: pageUrl,
    type: "article",
  },
...
export default function WhatAreTheEffectsOfSleepDeprivationPage() {
  return (
