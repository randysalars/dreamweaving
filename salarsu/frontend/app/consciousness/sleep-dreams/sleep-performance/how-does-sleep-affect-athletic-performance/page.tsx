...
const pageUrl = `${getSiteUrl()}/consciousness/sleep-dreams/sleep-performance/how-does-sleep-affect-athletic-performance`;

export const metadata: Metadata = {
  title: "How does sleep affect athletic performance? | Salars Consciousness",
  description: "How does sleep affect athletic performance?",
  alternates: { canonical: pageUrl },
  openGraph: {
    title: "How does sleep affect athletic performance?",
    description: "How does sleep affect athletic performance?",
    url: pageUrl,
    type: "article",
  },
...
export default function HowDoesSleepAffectAthleticPerformancePage() {
  return (
