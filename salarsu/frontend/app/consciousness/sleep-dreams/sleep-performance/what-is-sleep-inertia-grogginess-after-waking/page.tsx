...
const pageUrl = `${getSiteUrl()}/consciousness/sleep-dreams/sleep-performance/what-is-sleep-inertia-grogginess-after-waking`;

export const metadata: Metadata = {
  title: "What is sleep inertia (grogginess after waking)? | Salars Consciousness",
  description: "What is sleep inertia (grogginess after waking)?",
  alternates: { canonical: pageUrl },
  openGraph: {
    title: "What is sleep inertia (grogginess after waking)?",
    description: "What is sleep inertia (grogginess after waking)?",
    url: pageUrl,
    type: "article",
  },
...
export default function WhatIsSleepInertiaGrogginessAfterWakingPage() {
  return (
      ...
      <main className="container mx-auto px-4 py-12">
        <div className="mx-auto max-w-3xl space-y-8">
          ...
          <h1 className="text-4xl font-semibold tracking-tight text-foreground">
            What is sleep inertia (grogginess after waking)?
          </h1>
