...
const pageUrl = `${getSiteUrl()}/consciousness/sleep-dreams/sleep-performance/what-is-the-impact-of-sleep-on-emotional-regulation`;

export const metadata: Metadata = {
  title: "What is the impact of sleep on emotional regulation? | Salars Consciousness",
  description: "What is the impact of sleep on emotional regulation?",
  alternates: { canonical: pageUrl },
  openGraph: {
    title: "What is the impact of sleep on emotional regulation?",
    description: "What is the impact of sleep on emotional regulation?",
    url: pageUrl,
    type: "article",
  },
...
export default function WhatIsTheImpactOfSleepOnEmotionalRegulationPage() {
  return (
      ...
      <main className="container mx-auto px-4 py-12">
        <div className="mx-auto max-w-3xl space-y-8">
          ...
          <h1 className="text-4xl font-semibold tracking-tight text-foreground">
            What is the impact of sleep on emotional regulation?
          </h1>
