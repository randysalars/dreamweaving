...
const pageUrl = `${getSiteUrl()}/consciousness/sleep-dreams/sleep-performance/what-is-the-relationship-between-sleep-and-learning`;

export const metadata: Metadata = {
  title: "What is the relationship between sleep and learning? | Salars Consciousness",
  description: "What is the relationship between sleep and learning?",
  alternates: { canonical: pageUrl },
  openGraph: {
    title: "What is the relationship between sleep and learning?",
    description: "What is the relationship between sleep and learning?",
    url: pageUrl,
    type: "article",
  },
...
export default function WhatIsTheRelationshipBetweenSleepAndLearningPage() {
  return (
        ...
        <div className="mx-auto max-w-3xl space-y-8">
          ...
          <section className="rounded-2xl border border-border bg-card/40 p-6">
            ...
            <p className="text-lg text-foreground leading-relaxed">
              [Claude: Write 20-35 word answer to "What is the relationship between sleep and learning?"]
            </p>
          </section>
