...
const pageUrl = `${getSiteUrl()}/consciousness/sleep-dreams/sleep-performance/can-you-catch-up-on-lost-sleep`;

export const metadata: Metadata = {
  title: "Can you catch up on lost sleep? | Salars Consciousness",
  description: "Can you catch up on lost sleep?",
  alternates: { canonical: pageUrl },
  openGraph: {
    title: "Can you catch up on lost sleep?",
    description: "Can you catch up on lost sleep?",
    url: pageUrl,
    type: "article",
  },
...
export default function CanYouCatchUpOnLostSleepPage() {
  return (
