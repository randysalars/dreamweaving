...
const pageUrl = `${getSiteUrl()}/consciousness/sleep-dreams/sleep-performance/how-does-sleep-affect-immune-function`;

export const metadata: Metadata = {
  title: "How does sleep affect immune function? | Salars Consciousness",
  description: "How does sleep affect immune function?",
  alternates: { canonical: pageUrl },
  openGraph: {
    title: "How does sleep affect immune function?",
    description: "How does sleep affect immune function?",
    url: pageUrl,
    type: "article",
  },
...
export default function HowDoesSleepAffectImmuneFunctionPage() {
  return (
