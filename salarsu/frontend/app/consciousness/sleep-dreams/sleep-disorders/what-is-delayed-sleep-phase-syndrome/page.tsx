...
const pageUrl = `${getSiteUrl()}/consciousness/sleep-dreams/sleep-disorders/what-is-delayed-sleep-phase-syndrome`;

export const metadata: Metadata = {
  title: "What is delayed sleep phase syndrome? | Salars Consciousness",
  description: "What is delayed sleep phase syndrome?",
  alternates: { canonical: pageUrl },
  openGraph: {
    title: "What is delayed sleep phase syndrome?",
    description: "What is delayed sleep phase syndrome?",
    url: pageUrl,
    type: "article",
  },
...
export default function WhatIsDelayedSleepPhaseSyndromePage() {
  return (
