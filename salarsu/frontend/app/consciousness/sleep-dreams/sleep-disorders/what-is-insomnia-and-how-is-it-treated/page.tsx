...
const pageUrl = `${getSiteUrl()}/consciousness/sleep-dreams/sleep-disorders/what-is-insomnia-and-how-is-it-treated`;

export const metadata: Metadata = {
  title: "What is insomnia and how is it treated? | Salars Consciousness",
  description: "What is insomnia and how is it treated?",
  alternates: { canonical: pageUrl },
  openGraph: {
    title: "What is insomnia and how is it treated?",
    description: "What is insomnia and how is it treated?",
    url: pageUrl,
    type: "article",
  },
...
export default function WhatIsInsomniaAndHowIsItTreatedPage() {
  return (
        ...
        <div className="mx-auto max-w-3xl space-y-8">
          ...
          <section className="rounded-2xl border border-border bg-card/40 p-6">
            ...
            <p className="text-lg text-foreground leading-relaxed">
              [Claude: Write 20-35 word answer to "What is insomnia and how is it treated?"]
            </p>
          </section>
