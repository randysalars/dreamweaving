...
const pageUrl = `${getSiteUrl()}/consciousness/sleep-dreams/sleep-disorders/can-anxiety-cause-sleep-problems`;

export const metadata: Metadata = {
  title: "Can anxiety cause sleep problems? | Salars Consciousness",
  description: "Can anxiety cause sleep problems?",
  alternates: { canonical: pageUrl },
  openGraph: {
    title: "Can anxiety cause sleep problems?",
    description: "Can anxiety cause sleep problems?",
    url: pageUrl,
    type: "article",
  },
...
export default function CanAnxietyCauseSleepProblemsPage() {
  return (
