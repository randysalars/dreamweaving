...
const pageUrl = `${getSiteUrl()}/consciousness/sleep-dreams/sleep-disorders/what-is-sleep-maintenance-insomnia`;

export const metadata: Metadata = {
  title: "What is sleep maintenance insomnia? | Salars Consciousness",
  description: "What is sleep maintenance insomnia?",
  alternates: { canonical: pageUrl },
  openGraph: {
    title: "What is sleep maintenance insomnia?",
    description: "What is sleep maintenance insomnia?",
    url: pageUrl,
    type: "article",
  },
...
export default function WhatIsSleepMaintenanceInsomniaPage() {
  return (
