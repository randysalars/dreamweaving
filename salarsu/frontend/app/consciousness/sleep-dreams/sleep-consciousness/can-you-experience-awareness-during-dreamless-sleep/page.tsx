...
const pageUrl = `${getSiteUrl()}/consciousness/sleep-dreams/sleep-consciousness/can-you-experience-awareness-during-dreamless-sleep`;

export const metadata: Metadata = {
  title: "Can you experience awareness during dreamless sleep? | Salars Consciousness",
  description: "Can you experience awareness during dreamless sleep?",
  alternates: { canonical: pageUrl },
  openGraph: {
    title: "Can you experience awareness during dreamless sleep?",
    description: "Can you experience awareness during dreamless sleep?",
    url: pageUrl,
    type: "article",
  },
...
export default function CanYouExperienceAwarenessDuringDreamlessSleepPage() {
  return (
      ...
      <main className="container mx-auto px-4 py-12">
        <div className="mx-auto max-w-3xl space-y-8">
          ...
          <h1 className="text-4xl font-semibold tracking-tight text-foreground">
            Can you experience awareness during dreamless sleep?
          </h1>
