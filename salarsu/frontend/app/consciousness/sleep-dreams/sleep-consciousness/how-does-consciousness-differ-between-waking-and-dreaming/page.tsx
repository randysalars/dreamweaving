...
const pageUrl = `${getSiteUrl()}/consciousness/sleep-dreams/sleep-consciousness/how-does-consciousness-differ-between-waking-and-dreaming`;

export const metadata: Metadata = {
  title: "How does consciousness differ between waking and dreaming? | Salars Consciousness",
  description: "How does consciousness differ between waking and dreaming?",
  alternates: { canonical: pageUrl },
  openGraph: {
    title: "How does consciousness differ between waking and dreaming?",
    description: "How does consciousness differ between waking and dreaming?",
    url: pageUrl,
    type: "article",
  },
...
export default function HowDoesConsciousnessDifferBetweenWakingAndDreamingPage() {
  return (
      ...
      <main className="container mx-auto px-4 py-12">
        <div className="mx-auto max-w-3xl space-y-8">
          ...
          <h1 className="text-4xl font-semibold tracking-tight text-foreground">
            How does consciousness differ between waking and dreaming?
          </h1>
