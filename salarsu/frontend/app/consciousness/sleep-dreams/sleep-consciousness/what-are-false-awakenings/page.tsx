...
const pageUrl = `${getSiteUrl()}/consciousness/sleep-dreams/sleep-consciousness/what-are-false-awakenings`;

export const metadata: Metadata = {
  title: "What are false awakenings? | Salars Consciousness",
  description: "What are false awakenings?",
  alternates: { canonical: pageUrl },
  openGraph: {
    title: "What are false awakenings?",
    description: "What are false awakenings?",
    url: pageUrl,
    type: "article",
  },
...
export default function WhatAreFalseAwakeningsPage() {
  return (
