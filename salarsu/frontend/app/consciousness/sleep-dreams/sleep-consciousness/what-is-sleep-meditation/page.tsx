...
const pageUrl = `${getSiteUrl()}/consciousness/sleep-dreams/sleep-consciousness/what-is-sleep-meditation`;

export const metadata: Metadata = {
  title: "What is sleep meditation? | Salars Consciousness",
  description: "What is sleep meditation?",
  alternates: { canonical: pageUrl },
  openGraph: {
    title: "What is sleep meditation?",
    description: "What is sleep meditation?",
    url: pageUrl,
    type: "article",
  },
...
export default function WhatIsSleepMeditationPage() {
  return (
