...
const pageUrl = `${getSiteUrl()}/consciousness/sleep-dreams/sleep-consciousness/is-sleep-an-altered-state-of-consciousness`;

export const metadata: Metadata = {
  title: "Is sleep an altered state of consciousness? | Salars Consciousness",
  description: "Is sleep an altered state of consciousness?",
  alternates: { canonical: pageUrl },
  openGraph: {
    title: "Is sleep an altered state of consciousness?",
    description: "Is sleep an altered state of consciousness?",
    url: pageUrl,
    type: "article",
  },
...
export default function IsSleepAnAlteredStateOfConsciousnessPage() {
  return (
