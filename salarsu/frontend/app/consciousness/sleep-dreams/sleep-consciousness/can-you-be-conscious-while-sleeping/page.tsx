...
const pageUrl = `${getSiteUrl()}/consciousness/sleep-dreams/sleep-consciousness/can-you-be-conscious-while-sleeping`;

export const metadata: Metadata = {
  title: "Can you be conscious while sleeping? | Salars Consciousness",
  description: "Can you be conscious while sleeping?",
  alternates: { canonical: pageUrl },
  openGraph: {
    title: "Can you be conscious while sleeping?",
    description: "Can you be conscious while sleeping?",
    url: pageUrl,
    type: "article",
  },
...
export default function CanYouBeConsciousWhileSleepingPage() {
  return (
        ...
        <div className="mx-auto max-w-3xl space-y-8">
          ...
          <section className="rounded-2xl border border-border bg-card/40 p-6">
            ...
            <p className="text-lg text-foreground leading-relaxed">
              [Claude: Write 20-35 word answer to "Can you be conscious while sleeping?"]
            </p>
          </section>
