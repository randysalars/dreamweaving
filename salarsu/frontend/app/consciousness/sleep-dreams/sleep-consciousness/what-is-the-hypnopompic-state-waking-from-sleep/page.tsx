...
const pageUrl = `${getSiteUrl()}/consciousness/sleep-dreams/sleep-consciousness/what-is-the-hypnopompic-state-waking-from-sleep`;

export const metadata: Metadata = {
  title: "What is the hypnopompic state (waking from sleep)? | Salars Consciousness",
  description: "What is the hypnopompic state (waking from sleep)?",
  alternates: { canonical: pageUrl },
  openGraph: {
    title: "What is the hypnopompic state (waking from sleep)?",
    description: "What is the hypnopompic state (waking from sleep)?",
    url: pageUrl,
    type: "article",
  },
...
export default function WhatIsTheHypnopompicStateWakingFromSleepPage() {
  return (
      ...
      <main className="container mx-auto px-4 py-12">
        <div className="mx-auto max-w-3xl space-y-8">
          ...
          <h1 className="text-4xl font-semibold tracking-tight text-foreground">
            What is the hypnopompic state (waking from sleep)?
          </h1>
