...
const pageUrl = `${getSiteUrl()}/consciousness/sleep-dreams/sleep-optimization/does-alcohol-help-or-hurt-sleep`;

export const metadata: Metadata = {
  title: "Does alcohol help or hurt sleep? | Salars Consciousness",
  description: "Does alcohol help or hurt sleep?",
  alternates: { canonical: pageUrl },
  openGraph: {
    title: "Does alcohol help or hurt sleep?",
    description: "Does alcohol help or hurt sleep?",
    url: pageUrl,
    type: "article",
  },
...
export default function DoesAlcoholHelpOrHurtSleepPage() {
  return (
        ...
        <div className="mx-auto max-w-3xl space-y-8">
          ...
          <section className="rounded-2xl border border-border bg-card/40 p-6">
            ...
            <p className="text-lg text-foreground leading-relaxed">
              [Claude: Write 20-35 word answer to "Does alcohol help or hurt sleep?"]
            </p>
          </section>
