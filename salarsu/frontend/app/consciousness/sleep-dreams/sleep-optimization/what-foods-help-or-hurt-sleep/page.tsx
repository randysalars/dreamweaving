...
const pageUrl = `${getSiteUrl()}/consciousness/sleep-dreams/sleep-optimization/what-foods-help-or-hurt-sleep`;

export const metadata: Metadata = {
  title: "What foods help or hurt sleep? | Salars Consciousness",
  description: "What foods help or hurt sleep?",
  alternates: { canonical: pageUrl },
  openGraph: {
    title: "What foods help or hurt sleep?",
    description: "What foods help or hurt sleep?",
    url: pageUrl,
    type: "article",
  },
...
export default function WhatFoodsHelpOrHurtSleepPage() {
  return (
