...
const pageUrl = `${getSiteUrl()}/consciousness/sleep-dreams/sleep-optimization/how-does-exercise-affect-sleep`;

export const metadata: Metadata = {
  title: "How does exercise affect sleep? | Salars Consciousness",
  description: "How does exercise affect sleep?",
...
export default function HowDoesExerciseAffectSleepPage() {
  return (
