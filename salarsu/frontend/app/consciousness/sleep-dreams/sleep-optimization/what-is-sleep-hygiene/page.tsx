...
const pageUrl = `${getSiteUrl()}/consciousness/sleep-dreams/sleep-optimization/what-is-sleep-hygiene`;

export const metadata: Metadata = {
  title: "What is sleep hygiene? | Salars Consciousness",
  description: "What is sleep hygiene?",
...
export default function WhatIsSleepHygienePage() {
  return (
