...
const pageUrl = `${getSiteUrl()}/consciousness/sleep-dreams/sleep-optimization/what-is-the-best-bedtime-routine`;

export const metadata: Metadata = {
  title: "What is the best bedtime routine? | Salars Consciousness",
  description: "What is the best bedtime routine?",
  alternates: { canonical: pageUrl },
  openGraph: {
    title: "What is the best bedtime routine?",
    description: "What is the best bedtime routine?",
    url: pageUrl,
    type: "article",
  },
...
export default function WhatIsTheBestBedtimeRoutinePage() {
  return (
