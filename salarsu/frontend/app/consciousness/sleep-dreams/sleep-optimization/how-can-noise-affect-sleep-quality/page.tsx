...
const pageUrl = `${getSiteUrl()}/consciousness/sleep-dreams/sleep-optimization/how-can-noise-affect-sleep-quality`;

export const metadata: Metadata = {
  title: "How can noise affect sleep quality? | Salars Consciousness",
  description: "How can noise affect sleep quality?",
  alternates: { canonical: pageUrl },
  openGraph: {
    title: "How can noise affect sleep quality?",
    description: "How can noise affect sleep quality?",
    url: pageUrl,
    type: "article",
  },
...
export default function HowCanNoiseAffectSleepQualityPage() {
  return (
