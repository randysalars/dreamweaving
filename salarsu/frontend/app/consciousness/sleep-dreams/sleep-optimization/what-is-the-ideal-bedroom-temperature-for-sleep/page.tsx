...
const pageUrl = `${getSiteUrl()}/consciousness/sleep-dreams/sleep-optimization/what-is-the-ideal-bedroom-temperature-for-sleep`;

export const metadata: Metadata = {
  title: "What is the ideal bedroom temperature for sleep? | Salars Consciousness",
  description: "What is the ideal bedroom temperature for sleep?",
  alternates: { canonical: pageUrl },
  openGraph: {
    title: "What is the ideal bedroom temperature for sleep?",
    description: "What is the ideal bedroom temperature for sleep?",
    url: pageUrl,
    type: "article",
  },
...
export default function WhatIsTheIdealBedroomTemperatureForSleepPage() {
  return (
