...
const pageUrl = `${getSiteUrl()}/consciousness/sleep-dreams/sleep-optimization/should-you-avoid-screens-before-bed`;

export const metadata: Metadata = {
  title: "Should you avoid screens before bed? | Salars Consciousness",
  description: "Should you avoid screens before bed?",
  alternates: { canonical: pageUrl },
  openGraph: {
    title: "Should you avoid screens before bed?",
    description: "Should you avoid screens before bed?",
    url: pageUrl,
    type: "article",
  },
...
export default function ShouldYouAvoidScreensBeforeBedPage() {
  return (
