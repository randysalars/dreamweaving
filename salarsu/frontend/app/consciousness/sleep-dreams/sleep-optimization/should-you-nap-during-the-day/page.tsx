...
const pageUrl = `${getSiteUrl()}/consciousness/sleep-dreams/sleep-optimization/should-you-nap-during-the-day`;

export const metadata: Metadata = {
  title: "Should you nap during the day? | Salars Consciousness",
  description: "Should you nap during the day?",
  alternates: { canonical: pageUrl },
  openGraph: {
    title: "Should you nap during the day?",
    description: "Should you nap during the day?",
    url: pageUrl,
    type: "article",
  },
...
export default function ShouldYouNapDuringTheDayPage() {
  return (
