...
const pageUrl = `${getSiteUrl()}/consciousness/sleep-dreams/sleep-optimization/do-sleep-trackers-actually-work`;

export const metadata: Metadata = {
  title: "Do sleep trackers actually work? | Salars Consciousness",
  description: "Do sleep trackers actually work?",
  alternates: { canonical: pageUrl },
  openGraph: {
    title: "Do sleep trackers actually work?",
    description: "Do sleep trackers actually work?",
    url: pageUrl,
    type: "article",
  },
...
export default function DoSleepTrackersActuallyWorkPage() {
  return (
