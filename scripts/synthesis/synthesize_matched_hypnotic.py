...
def main():
    ...
    result = os.system("ffmpeg -f concat -safe 0 -i filelist.txt -c copy hypnotic_opening_matched.mp3 -y 2>/dev/null")
    
    if result == 0 and os.path.exists('hypnotic_opening_matched.mp3'):
        print("\n" + "="*60)
