...
def main():
    ...
    result = os.system("ffmpeg -f concat -safe 0 -i filelist.txt -c copy ai_pretalk_natural.mp3 -y 2>/dev/null")
    
    if result == 0 and os.path.exists('ai_pretalk_natural.mp3'):
        print("\n" + "="*60)
        print("✓ SUCCESS!")
        print("="*60)
