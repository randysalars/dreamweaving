#!/usr/bin/env python3
"""
Natural Introduction Synthesis - Refactored Version

Natural, conversational introduction (non-hypnotic).
...
class NaturalIntroSynthesizer(BaseSynthesizer):
    """Synthesize natural, conversational introduction (non-hypnotic)."""

    name = "Natural Introduction - Conversational Style"
    output_filename = "intro_natural.mp3"
    voice_name = "en-US-Neural2-I"
    speaking_rate = 1.0
    pitch = 0.0
    volume_gain_db = 0.0
    description = "Natural, conversational, friendly and informative"
    duration_estimate = "~3-4 minutes"

    def get_chunks(self) -> List[str]:
        """Return SSML chunks for the natural introduction."""
        return [
...
if __name__ == "__main__":
    synthesizer = NaturalIntroSynthesizer()
    synthesizer.run()
