...
class SegmentManager:
    ...
    BUILT_IN_SEGMENTS = {
        ...
        # New Nurture Sequences
        "ai_segment": {
            "description": "Interested in Artificial Intelligence",
            "filters": {"interests": ["ai"]},
            "sequence": "ai"
        },
        "consciousness_segment": {
            "description": "Interested in Learning & Consciousness",
            "filters": {"interests": ["consciousness"]},
            "sequence": "consciousness"
        },
        "survival_segment": {
            "description": "Interested in Survival & Self-Reliance",
            "filters": {"interests": ["survival"]},
            "sequence": "survival"
        },
        "health_segment": {
            "description": "Interested in Health & Wellness",
            "filters": {"interests": ["health"]},
            "sequence": "health"
        },
        "wealth_segment": {
            "description": "Interested in Wealth & Abundance",
            "filters": {"interests": ["wealth"]},
            "sequence": "wealth"
        },
        "love_segment": {
            "description": "Interested in Love & Relationships",
            "filters": {"interests": ["love"]},
            "sequence": "love"
        },
        "happiness_segment": {
            "description": "Interested in Happiness & Joy",
            "filters": {"interests": ["happiness"]},
            "sequence": "happiness"
        },
        "spirituality_segment": {
            "description": "Interested in Spirituality & Inner Growth",
            "filters": {"interests": ["spirituality"]},
            "sequence": "spirituality"
        },
        "poetry_segment": {
            "description": "Interested in Poetry & Creative Expression",
            "filters": {"interests": ["poetry"]},
            "sequence": "poetry"
        },
        "old_west_segment": {
            "description": "Interested in the Old West",
            "filters": {"interests": ["old_west"]},
            "sequence": "old_west"
        },
        "treasure_segment": {
            "description": "Interested in Treasure & Discovery",
            "filters": {"interests": ["treasure"]},
            "sequence": "treasure"
        },
        "dreamweaving_segment": {
            "description": "Core Dreamweaving & Slow Business philosophy",
            "filters": {"interests": ["dreamweaving"]},
            "sequence": "dreamweaving"
        }
    }
