...
4. Generate audio:
   ...
   python scripts/core/build_session.py \
       --session sessions/temple-of-a-thousand-steps \
       --ssml sessions/temple-of-a-thousand-steps/script.ssml
   ```

## Validate Structure

```bash
python scripts/utilities/validate_session_structure.py sessions/temple-of-a-thousand-steps
```
