#!/usr/bin/env python3
"""
Mix full-length Ava voice with complete binaural beats
Both are now 1887 seconds (31.45 minutes)
"""
...
def mix_audio():
    print("=" * 70)
    print("ATLAS: Mixing Full Ava Voice with Complete Binaural Beats")
    print("=" * 70)
    print()

    # Load files
    voice_file = Path("working_files/voice_atlas_ava_full.mp3")
    binaural_file = Path("working_files/binaural_atlas_complete.wav")
    output_file = Path("working_files/atlas_ava_complete_mixed.wav")
