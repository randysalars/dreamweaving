...
const pageUrl = `${getSiteUrl()}/consciousness/sleep-dreams/dream-science/what-causes-vivid-dreams`;

export const metadata: Metadata = {
  title: "What causes vivid dreams? | Salars Consciousness",
  description: "What causes vivid dreams?",
  alternates: { canonical: pageUrl },
  openGraph: {
    title: "What causes vivid dreams?",
    description: "What causes vivid dreams?",
    url: pageUrl,
    type: "article",
  },
...
export default function WhatCausesVividDreamsPage() {
  return (
