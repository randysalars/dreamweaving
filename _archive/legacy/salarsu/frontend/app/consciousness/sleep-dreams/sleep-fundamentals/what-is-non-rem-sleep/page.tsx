...
const pageUrl = `${getSiteUrl()}/consciousness/sleep-dreams/sleep-fundamentals/what-is-non-rem-sleep`;

export const metadata: Metadata = {
  title: "What is non-REM sleep? | Salars Consciousness",
  description: "What is non-REM sleep?",
  alternates: { canonical: pageUrl },
  openGraph: {
    title: "What is non-REM sleep?",
    description: "What is non-REM sleep?",
    url: pageUrl,
    type: "article",
  },
...
export default function WhatIsNonRemSleepPage() {
  return (
