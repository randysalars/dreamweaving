...
const pageUrl = `${getSiteUrl()}/consciousness/memory/fundamentals/what-are-the-different-types-of-memory-short-term-long-term-working`;

export const metadata: Metadata = {
  title: "What are the different types of memory (short-term, long-term, working)? | Salars Consciousness",
  description: "What are the different types of memory (short-term, long-term, working)?",
  alternates: { canonical: pageUrl },
  openGraph: {
    title: "What are the different types of memory (short-term, long-term, working)?",
    description: "What are the different types of memory (short-term, long-term, working)?",
    url: pageUrl,
    type: "article",
  },
...
export default function WhatAreTheDifferentTypesOfMemoryShortTermLongTermWorkingPage() {
  return (
        ...
        <div className="mx-auto max-w-3xl space-y-8">
          ...
          <section className="rounded-2xl border border-border bg-card/40 p-6">
            ...
            <p className="text-lg text-foreground leading-relaxed">
              [Claude: Write 20-35 word answer to "What are the different types of memory (short-term, long-term, working)?"]
            </p>
          </section>
          ...
          <section className="space-y-4">
            ...
            <div className="grid gap-3">
              ...
              <Link
                href="/consciousness/memory/fundamentals/can-memory-be-improved-with-practice"
                className="flex items-start gap-3 rounded-lg border border-border bg-card/30 p-4 transition-colors hover:bg-card/50"
              >
                <HelpCircle className="h-5 w-5 text-primary mt-0.5 flex-shrink-0" />
                <span className="text-foreground">Can memory be improved with practice?</span>
              </Link>
