...
const pageUrl = `${getSiteUrl()}/consciousness/memory/fundamentals/how-do-emotions-influence-memory`;

export const metadata: Metadata = {
  title: "How do emotions influence memory? | Salars Consciousness",
  description: "How do emotions influence memory?",
  alternates: { canonical: pageUrl },
  openGraph: {
    title: "How do emotions influence memory?",
    description: "How do emotions influence memory?",
    url: pageUrl,
    type: "article",
  },
...
export default function HowDoEmotionsInfluenceMemoryPage() {
  return (
        ...
        <div className="mx-auto max-w-3xl space-y-8">
          ...
          <section className="rounded-2xl border border-border bg-card/40 p-6">
            ...
            <p className="text-lg text-foreground leading-relaxed">
              [Claude: Write 20-35 word answer to "How do emotions influence memory?"]
            </p>
          </section>
