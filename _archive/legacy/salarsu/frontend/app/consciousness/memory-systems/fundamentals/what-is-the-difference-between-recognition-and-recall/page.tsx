...
const pageUrl = `${getSiteUrl()}/consciousness/memory/fundamentals/what-is-the-difference-between-recognition-and-recall`;

export const metadata: Metadata = {
  title: "What is the difference between recognition and recall? | Salars Consciousness",
  description: "What is the difference between recognition and recall?",
  alternates: { canonical: pageUrl },
  openGraph: {
    title: "What is the difference between recognition and recall?",
    description: "What is the difference between recognition and recall?",
    url: pageUrl,
    type: "article",
  },
...
export default function WhatIsTheDifferenceBetweenRecognitionAndRecallPage() {
  return (
        ...
        <div className="mx-auto max-w-3xl space-y-8">
          ...
          <section className="rounded-2xl border border-border bg-card/40 p-6">
            ...
            <p className="text-lg text-foreground leading-relaxed">
              [Claude: Write 20-35 word answer to "What is the difference between recognition and recall?"]
            </p>
          </section>
