...
const pageUrl = `${getSiteUrl()}/consciousness/memory/fundamentals/what-is-working-memory-and-why-is-it-important`;

export const metadata: Metadata = {
  title: "What is working memory and why is it important? | Salars Consciousness",
  description: "What is working memory and why is it important?",
  alternates: { canonical: pageUrl },
  openGraph: {
    title: "What is working memory and why is it important?",
    description: "What is working memory and why is it important?",
    url: pageUrl,
    type: "article",
  },
...
export default function WhatIsWorkingMemoryAndWhyIsItImportantPage() {
  return (
        ...
        <div className="mx-auto max-w-3xl space-y-8">
          ...
          <section className="rounded-2xl border border-border bg-card/40 p-6">
            ...
            <p className="text-lg text-foreground leading-relaxed">
              [Claude: Write 20-35 word answer to "What is working memory and why is it important?"]
            </p>
          </section>
