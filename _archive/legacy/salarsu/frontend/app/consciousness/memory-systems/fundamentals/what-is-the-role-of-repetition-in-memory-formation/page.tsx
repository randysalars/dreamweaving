...
const pageUrl = `${getSiteUrl()}/consciousness/memory/fundamentals/what-is-the-role-of-repetition-in-memory-formation`;

export const metadata: Metadata = {
  title: "What is the role of repetition in memory formation? | Salars Consciousness",
  description: "What is the role of repetition in memory formation?",
  alternates: { canonical: pageUrl },
  openGraph: {
    title: "What is the role of repetition in memory formation?",
    description: "What is the role of repetition in memory formation?",
    url: pageUrl,
    type: "article",
  },
...
export default function WhatIsTheRoleOfRepetitionInMemoryFormationPage() {
  return (
      ...
      <main className="container mx-auto px-4 py-12">
        <div className="mx-auto max-w-3xl space-y-8">
          ...
          <h1 className="text-4xl font-semibold tracking-tight text-foreground">
            What is the role of repetition in memory formation?
          </h1>
          ...
          <section className="rounded-2xl border border-border bg-card/40 p-6">
            ...
            <p className="text-lg text-foreground leading-relaxed">
              [Claude: Write 20-35 word answer to "What is the role of repetition in memory formation?"]
            </p>
          </section>
