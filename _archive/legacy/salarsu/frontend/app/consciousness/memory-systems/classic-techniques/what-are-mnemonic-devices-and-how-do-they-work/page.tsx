...
const pageUrl = `${getSiteUrl()}/consciousness/memory/classic-techniques/what-are-mnemonic-devices-and-how-do-they-work`;

export const metadata: Metadata = {
  title: "What are mnemonic devices and how do they work? | Salars Consciousness",
  description: "What are mnemonic devices and how do they work?",
  alternates: { canonical: pageUrl },
  openGraph: {
    title: "What are mnemonic devices and how do they work?",
    description: "What are mnemonic devices and how do they work?",
    url: pageUrl,
    type: "article",
  },
...
export default function WhatAreMnemonicDevicesAndHowDoTheyWorkPage() {
  return (
        ...
        <div className="mx-auto max-w-3xl space-y-8">
          ...
          <section className="rounded-2xl border border-border bg-card/40 p-6">
            ...
            <p className="text-lg text-foreground leading-relaxed">
              [Claude: Write 20-35 word answer to "What are mnemonic devices and how do they work?"]
            </p>
          </section>
