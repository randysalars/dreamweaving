...
const pageUrl = `${getSiteUrl()}/consciousness/memory/classic-techniques/what-is-chunking-and-how-does-it-improve-memory`;

export const metadata: Metadata = {
  title: "What is chunking and how does it improve memory? | Salars Consciousness",
  description: "What is chunking and how does it improve memory?",
  alternates: { canonical: pageUrl },
  openGraph: {
    title: "What is chunking and how does it improve memory?",
    description: "What is chunking and how does it improve memory?",
    url: pageUrl,
    type: "article",
  },
...
export default function WhatIsChunkingAndHowDoesItImproveMemoryPage() {
  return (
        ...
        <div className="mx-auto max-w-3xl space-y-8">
          ...
          <section className="rounded-2xl border border-border bg-card/40 p-6">
            ...
            <p className="text-lg text-foreground leading-relaxed">
              [Claude: Write 20-35 word answer to "What is chunking and how does it improve memory?"]
            </p>
          </section>
