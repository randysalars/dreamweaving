...
const pageUrl = `${getSiteUrl()}/consciousness/memory/practical-applications/what-is-the-best-way-to-memorize-vocabulary`;

export const metadata: Metadata = {
  title: "What is the best way to memorize vocabulary? | Salars Consciousness",
  description: "What is the best way to memorize vocabulary?",
  alternates: { canonical: pageUrl },
  openGraph: {
    title: "What is the best way to memorize vocabulary?",
    description: "What is the best way to memorize vocabulary?",
    url: pageUrl,
    type: "article",
  },
...
export default function WhatIsTheBestWayToMemorizeVocabularyPage() {
  return (
        ...
        <div className="mx-auto max-w-3xl space-y-8">
          ...
          <section className="rounded-2xl border border-border bg-card/40 p-6">
            ...
            <p className="text-lg text-foreground leading-relaxed">
              [Claude: Write 20-35 word answer to "What is the best way to memorize vocabulary?"]
            </p>
          </section>
