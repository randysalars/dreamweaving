...
const pageUrl = `${getSiteUrl()}/consciousness/memory/modern-approaches/what-is-active-recall-and-how-is-it-different-from-re-reading`;

export const metadata: Metadata = {
  title: "What is active recall and how is it different from re-reading? | Salars Consciousness",
  description: "What is active recall and how is it different from re-reading?",
  alternates: { canonical: pageUrl },
  openGraph: {
    title: "What is active recall and how is it different from re-reading?",
    description: "What is active recall and how is it different from re-reading?",
    url: pageUrl,
    type: "article",
  },
...
export default function WhatIsActiveRecallAndHowIsItDifferentFromReReadingPage() {
  return (
        ...
        <div className="mx-auto max-w-3xl space-y-8">
          ...
          <section className="rounded-2xl border border-border bg-card/40 p-6">
            ...
            <p className="text-lg text-foreground leading-relaxed">
              [Claude: Write 20-35 word answer to "What is active recall and how is it different from re-reading?"]
            </p>
          </section>
          ...
          <section className="space-y-4">
            ...
            <div className="grid gap-3">
              ...
              <Link
                href="/consciousness/memory/modern-approaches/which-memory-apps-are-most-effective-anki-quizlet-etc"
                className="flex items-start gap-3 rounded-lg border border-border bg-card/30 p-4 transition-colors hover:bg-card/50"
              >
                <HelpCircle className="h-5 w-5 text-primary mt-0.5 flex-shrink-0" />
                <span className="text-foreground">Which memory apps are most effective (Anki, Quizlet, etc.)?</span>
              </Link>
